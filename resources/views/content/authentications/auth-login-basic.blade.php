            ...
            <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <div id="licenseActivation" style="display: none;">
                        ...
                        <form id="formLicenseActivation" class="mb-3" action="{{ route('verify-license') }}"
                            method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="domain" class="form-label">Domínio</label>
                                <input type="text" class="form-control" id="domain" name="domain"
                                    placeholder="Digite seu domínio" value="{{ request()->getHost() }}" readonly>
                            </div>
                            <div class="mb-3">
                                ...
                                @if ($errors->has('license_key'))
                                    <span class="text-danger">{{ $errors->first('license_key') }}</span>
                                @endif
                            </div>
                            <div class="mb-3">
