...
class LoginBasic extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        $responseData = $this->licenseService->checkLicenseStatus($domain);
    
        if (!$responseData['success'] || !$responseData['is_active']) {
            return response()->json(['errors' => ['license' => 'Licença inválida ou inativa.']], 403);
        }
